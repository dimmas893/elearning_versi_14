...
Route::get('/semua/nilai', [App\Http\Controllers\Guru\RaportController::class, 'index'])->name('raport');
Route::get('/semua/raport/get', [App\Http\Controllers\Guru\RaportController::class, 'raport'])->name('raport_get');
